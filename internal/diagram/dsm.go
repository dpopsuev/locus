...
// renderDSM renders a Dependency Structure Matrix as a text table.
...
// pre-formatted text table with × markers for dependencies.
func renderDSM(in Input, _ Options) string {
